...
class Board:
    ...
    def evaluate(self):
        return self.white_left - self.BROWN_left + (self.white_kings * 2 - self.BROWN_kings * 2)
...
class Game:
 ...
 # min max with alpha beta pruning for deciding AI move
...
#assigning width and height to the game window         
...
def main():
    ...
    while run:
        ...
        if game.turn == WHITE:
            value, new_board = minimaxwitha_b(game.get_board(),3, WHITE, game,alpha,beta)
